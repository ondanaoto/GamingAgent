...
from games.phoenix.workers import phoenix_worker
from tools.utils import str2bool
# System prompt remains constant
system_prompt = (  
    "You are a highly intelligent Phoenix Wright: Ace Attorney gameplay agent trained to achieve the highest possible score "  
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Phoenix Wright: Ace Attorney grid processing with configurable parameters."
    )
    ...
    parser.add_argument("--crop_left", type=int, default=0, help="Pixels to crop from the left.")
    parser.add_argument("--crop_right", type=int, default=730, help="Pixels to crop from the right.")
    parser.add_argument("--crop_top", type=int, default=230, help="Pixels to crop from the top.")
